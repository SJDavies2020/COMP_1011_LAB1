...
public Game(String gameName, String publishYear, boolean isPublished, LocalDate releaseDate, String gameType, double gamePrice) {
    ...
    public void setGameType(String gameType) {
        ...
        List<String> validChoice = asList("2D Platformer","3D Platformer", "FPS", "MMO");
